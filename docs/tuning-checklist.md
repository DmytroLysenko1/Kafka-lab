...
| static membership (`group.instance.id`) and a rebalance caused by a member **leaving** | exp-14 only adds a member; both are runnable on this stand and simply have not been run |
